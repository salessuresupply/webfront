...
import { LinkedIn, Home, Phone as PhoneIcon, Facebook, Close as CloseIcon, MailOutline } from "@mui/icons-material";  // Added MailOutline
...
const Footer = () => {
  return (
    <ThemeProvider theme={theme}>
      <Box
        sx={{ backgroundColor: "#3f51b5", color: "#fff", padding: "50px 0", marginTop: "50px" }}
        // sx={{ backgroundColor: "#F5F5F5", color: "#fff", padding: "50px 0", marginTop: "50px" }}
      >
            ...
            <Grid item xs={12} sm={4} textAlign="center">
              ...
              <Typography variant="body1" color="inherit">
                ...
                <Link href="https://twitter.com/" target="_blank" color="inherit" underline="hover">
                  <CloseIcon sx={{ verticalAlign: "middle" }} /> {/* Replaced Twitter icon with Close (X) icon */}
                </Link>
              </Typography>
            </Grid>
